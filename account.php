  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="IMG_20180722_191058" width=100 height=100 alt="Swapnil surawar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/swapnilsurawar" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Swapnil Rajesh Surawar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+918830819250</h4>
		<h4 style="font-family:'typo' ">surawarswapnil@gmail.com</h4>
